/*-------------------------------------------------------*/
/*                   修改控件的配置信息                    */
/* version:2.3.2(20200710) 升级到 version:2.5.1(20201231) */
/*                                                       */
/*-------------------------------------------------------*/
//64位控件的calssid
...
//32位控件包的路径
var codebase="officecontrol/cab/ofctnewclsid.cab#version=6.0.1.0";
//64位控件包的路径
var codebase64="officecontrol/cab/ofctnewclsidx64.cab#version=6.0.1.0";
//设置高度
var height="800px";
//设置宽度
var width="100%";
//买断授权密钥如果不是买断可以不用写
var MakerCaption="鼎捷软件股份有限公司";
//买断授权密钥如果不是买断可以不用写
var MakerKey="2DDF6D465C8EFEFBC65F67CDD1A549D68B22A1D5";
//密钥
var ProductCaption="在线编辑";
//密钥
var ProductKey="DE29BEBBD8EE02AE8404DE26388CC92112160798";
//解除时间密钥
var NoExpireKey="";
...
if (browser=="IE"){
    if(window.navigator.platform=="Win32"){
        ...
        document.write('<param name="Caption" value=" 双击全屏显示">   ');
